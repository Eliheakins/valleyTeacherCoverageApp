...
Launch the Program: Run the executable file (CoverageApp.app/.exe). Note: For Mac this file needs to be located in the Applications folder to run properly. 
...
The program relies on very specific Excel formatting.
